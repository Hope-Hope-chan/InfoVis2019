function Isosurfaces( volume, point, normal )
{
    ...
    var t = new THREE.Vector4( normal.x, normal.y, normal.z, w );
	...
	if( v0.x != v1.x ){
	    var s0 = v0.x;
	    var s1 = v1.x;
	    var s =  (-t.y * v0.y - t.z * v0.z -t.w) / t.x;
	    return new THREE.Vector3( s , v0.y , v0.z );
	}
	if( v0.y != v1.y ){
	    var s0 = v0.y;
	    var s1 = v1.y;
	    var s =   (-t.x * v0.x - t.z * v0.z -t.w) / t.y;
	    return new THREE.Vector3( v0.x , s , v0.z );
	}
	if( v0.z != v1.z ){
	    var s0 = v0.z;
	    var s1 = v1.z;
	    var s =  (-t.x * v0.x - t.y * v0.y -t.w) / t.z;
